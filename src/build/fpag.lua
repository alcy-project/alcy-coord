package("fpag")
    ...
    set_description("The libfpag package")
    ...
    add_configs("fmtlib", {description = 'Use fmtlib for formatting (You need to manually execute add_requires("fmt <version>") with correct version and add_packages("fmt").)', default = true, type = "boolean"})
    add_configs("libunwind", {description = "Use libunwind for stack tracing", default = false, type = "boolean"})
    add_configs("stdlib", {description = "stl to use", default = "libstdc++", type = "string"})
